...
This is a Mule 4.3 example of an API using API Management that can be used as a starting point for building system APIs in Mule 4.3.
...
* json.logger.application.name contains the application NAME
* json.logger.application.version contains the application version
* json.logger.disabled.fields contains the fields that needs to be avoided in the log e.g., PII data (e.g., SSN, Credit Card Number etc.)
